...
class BERTFeatureExtractor:
    ...
    def create_mask(self, sentence_length, e1_start, e1_end, e2_start, e2_end):
    ...
    def truncate_if_needed(self, tokenized_sentence, mask):
    ...
    def add_bert_tokens(self, tokenized_sentence, mask):
